 ...
 * 
  ...
  * export function  sortObjectArrayByStringKey
  * export function  sortNumberArray
  * export function  sortObjectArrayByNumberKey
  * export function  sortKeysByOtherKey
  * 
 */


 import { ISeriesSort } from '../../CSSCharts/ICSSCharts';
...
export function sortKeysByOtherKey( obj: any, sortKey: ISeriesSort, order: ISeriesSort, dataType: 'number' | 'string', otherKeys: string[], convertNullToEmpty: boolean = false, localLanguage: string = '' ) {
